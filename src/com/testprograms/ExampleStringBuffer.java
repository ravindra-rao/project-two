...
public class ExampleStringBuffer {
	...
	public static void main(String[] args) {
		...
		sb1.reverse();
		System.out.println(sb1);
		System.out.println(sb1.reverse()); // even if we modify the string in print statement, the string object holds
											// its state
		System.out.println(sb1);
		...
		// substring
		// is used to return the substring from the specified beginIndex OR from the
		// specified beginIndex and endIndex.
